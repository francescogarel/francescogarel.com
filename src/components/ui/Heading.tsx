...
const VARIANTS = {
    ...
    h3: `[font-size:clamp(1.522rem,calc(1.345rem+0.861vw),1.791rem)] tracking-[0.016em] font-[600] leading-[1.47]`,
    h4: `[font-size:clamp(1.399rem,calc(1.272rem+0.616vw),1.334rem)] tracking-[0.016em] font-[500] leading-[1.47]`,
